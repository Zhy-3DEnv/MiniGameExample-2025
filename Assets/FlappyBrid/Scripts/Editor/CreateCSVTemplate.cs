...
public class CreateCSVTemplate
{
    ...
    public static void CreateTemplate()
    {
        ...
        string templateContent = @"关卡编号,关卡名称,目标分数,生成率倍数,移动速度倍数,高度偏移,管道通过分数,完成奖励,关卡描述,使用关卡道具设置,道具生成概率,道具X轴偏移
1,关卡1,10,1,0.5,2,1,1,第一关,是,0.3,0
2,关卡2,20,1.2,0.6,3,1,2,第二关,是,0.3,0
3,关卡3,30,1.5,0.7,4,1,3,第三关,是,0.4,0
4,关卡4,40,1.8,0.8,5,1,4,第四关,是,0.4,0
5,关卡5,50,2,0.9,6,1,5,第五关,是,0.5,0";
    ...
    public static void CreateExcelTemplate()
    {
        ...
        string templateContent = @"关卡编号,关卡名称,目标分数,生成率倍数,移动速度倍数,高度偏移,管道通过分数,完成奖励,关卡描述,使用关卡道具设置,道具生成概率,道具X轴偏移,背景颜色
1,关卡1,10,1,0.5,2,1,1,第一关,是,0.3,0,
2,关卡2,20,1.2,0.6,3,1,2,第二关,是,0.3,0,
3,关卡3,30,1.5,0.7,4,1,3,第三关,是,0.4,0,
4,关卡4,40,1.8,0.8,5,1,4,第四关,是,0.4,0,
